const hstr = `
  ...
  <script src="/resources/js/plugins/gsap@3.12.5/gsap.min.js"></script>
  <script src="/resources/js/plugins/gsap@3.12.5/MotionPathPlugin.min.js"></script>
  ...
  <script defer type="module" src="/resources/js/gsapMotion.js"></script>
  <script defer src="/resources/js/UI_common.js"></script>
  <title>NETIVE</title>
`;
document.write(hstr);
